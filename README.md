...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create oabnamedida-com-br-102d
  fly apps create oabnamedida-com-br-102d-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app oabnamedida-com-br-102d
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app oabnamedida-com-br-102d-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'oabnamedida-com-br-102d-staging' does not match app name in config file 'oabnamedida-com-br-102d'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name oabnamedida-com-br-102d-db
  fly postgres attach --app oabnamedida-com-br-102d oabnamedida-com-br-102d-db

  fly postgres create --name oabnamedida-com-br-102d-staging-db
  fly postgres attach --app oabnamedida-com-br-102d-staging oabnamedida-com-br-102d-staging-db
  ```
